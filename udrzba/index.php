...
if($maintenance == 0 OR in_array($ip,$whitelist)){
	header("Location: http://www.chochrun.eu/");
}
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="page">
				<div class="wrapper">
					<div class="container">
						...
						<h1 class="heading"><i class="fa fa-exclamation-triangle"></i>  Právě probíhá údržba <i class="fa fa-exclamation-triangle"></i></h1>
						<p>
							Pro zlepšení kvality našich služeb jsou stránky momentálně nedostupné.
						</p>
						<p>
